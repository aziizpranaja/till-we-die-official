    ...
    <section id="tour" className="relative py-24 md:py-32 bg-secondary/30 border-y border-border overflow-hidden">
      ...
      <div className="container relative">
        <div className="mb-16 max-w-2xl">
          <span className="text-xs uppercase tracking-[0.4em] text-primary font-bebas">/ 04 — Tour 2025</span>
          ...
          {events.map((e, i) => (
            ...
            >
              <div className="col-span-12 md:col-span-2 flex items-baseline gap-2">
                ...
                <div>
                  <div className="font-bebas text-3xl md:text-4xl leading-none">{e.date}</div>
                  <div className="text-xs text-muted-foreground font-mono">{e.year}</div>
                </div>
              </div>

              <div className="col-span-7 md:col-span-3">
                <div className="text-xs uppercase tracking-widest text-muted-foreground font-bebas">City</div>
                <div className="font-script text-2xl md:text-3xl text-primary">{e.city}</div>
              </div>
